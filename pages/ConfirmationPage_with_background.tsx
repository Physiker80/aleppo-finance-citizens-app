...
const ConfirmationPage: React.FC = () => {
  ...
  return (
    ...
    {/* Hidden content for PDF generation with beautiful background */}
        ...
        <div style={{ 
            ...
            <div style={{
                ...
                backgroundImage: `
                    ...
                    radial-gradient(circle at 50% 10%, rgba(255, 255, 255, 0.15) 0%, transparent 40%)
                `,
                zIndex: 1
            }}></div>
          ...
          <div style={{textAlign: 'right'}}>
            ...
            <div style={{ marginTop: '50px', textAlign: 'center', backgroundColor: 'rgba(248, 249, 250, 0.8)', padding: '30px', borderRadius: '12px', border: '2px solid #0f3c35', backdropFilter: 'blur(5px)' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-start', gap: '30px', marginBottom: '20px' }}>
                    ...
                    {/* Tracking Number Display */}
                    <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.9)', padding: '20px', borderRadius: '8px', border: '2px dashed #0f3c35', minWidth: '300px' }}>
                ...
                {/* Instructions */}
                <div style={{ backgroundColor: 'rgba(232, 245, 232, 0.9)', padding: '20px', borderRadius: '8px', textAlign: 'right' }}>
                ...
                {/* Important Notes */}
                <div style={{ backgroundColor: 'rgba(255, 243, 205, 0.9)', padding: '20px', borderRadius: '8px', marginTop: '20px', textAlign: 'right' }}>
